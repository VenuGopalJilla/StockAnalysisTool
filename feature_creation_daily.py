...
def perform_operation(security_code):
    try:
        ...
        corporate_df = pd.read_csv(os.path.join(
            path, "SP500_CorporateActions/"+security_code+".csv"))
        revenue_df = pd.read_csv(os.path.join(
            path, "SP500_Revenue/"+security_code+".csv"))
        stock_df = pd.read_csv(os.path.join(
            path, "SP500_Stock/"+security_code+".csv"))
        gr_stock_df = pd.read_csv(os.path.join(
            path, "SP500_GRStock/"+"gr"+security_code+".csv"))
        ...
        result.to_csv(os.path.join(path, "SP500_GRStock/"+"gr" +
                      str(security_code)+".csv"), index=False)
    except:
        traceback.print_exc()


df = pd.read_csv(os.path.join(path, "SP500companies.csv"))

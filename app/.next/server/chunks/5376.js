...
var FormControlContext = external_react_.createContext();

if (false) {}

function useFormControl() {
  return external_react_.useContext(FormControlContext);
}
...
var TextareaAutosize = /*#__PURE__*/external_react_.forwardRef(function TextareaAutosize(props, ref) {
  ...
  var _React$useRef = external_react_.useRef(value != null),
      isControlled = _React$useRef.current;

  var inputRef = external_react_.useRef(null);
  var handleRef = (0,useForkRef/* default */.Z)(ref, inputRef);
  var shadowRef = external_react_.useRef(null);
  var renders = external_react_.useRef(0);

  var _React$useState = external_react_.useState({}),
      state = _React$useState[0],
      setState = _React$useState[1];

  var syncHeight = external_react_.useCallback(function () {
  ...
  return /*#__PURE__*/external_react_.createElement(external_react_.Fragment, null, /*#__PURE__*/external_react_.createElement("textarea", (0,esm_extends/* default */.Z)({
    value: value,
  ...
  }, other)), /*#__PURE__*/external_react_.createElement("textarea", {
    "aria-hidden": true,
...
var InputBase_useEnhancedEffect = typeof window === 'undefined' ? external_react_.useEffect : external_react_.useLayoutEffect;
/**
...
var InputBase = /*#__PURE__*/external_react_.forwardRef(function InputBase(props, ref) {
  ...
  var inputRef = external_react_.useRef();
  var handleInputRefWarning = external_react_.useCallback(function (instance) {
    if (false) {}
  }, []);
  ...
  var checkDirty = external_react_.useCallback(function (obj) {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  var handleChange = function handleChange(event) {
    if (!isControlled) {
      ...
      if (element == null) {
        throw new Error( false ? 0 : (0,utils_.formatMuiErrorMessage)(1));
      }
  ...
  return /*#__PURE__*/external_react_.createElement("div", (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, classes["color".concat((0,capitalize/* default */.Z)(fcs.color || 'primary'))], className, fcs.disabled && classes.disabled, fcs.error && classes.error, fullWidth && classes.fullWidth, fcs.focused && classes.focused, muiFormControl && classes.formControl, multiline && classes.multiline, startAdornment && classes.adornedStart, endAdornment && classes.adornedEnd, fcs.margin === 'dense' && classes.marginDense),
    onClick: handleClick,
    ref: ref
  }, other), startAdornment, /*#__PURE__*/external_react_.createElement(FormControl_FormControlContext.Provider, {
    value: null
  }, /*#__PURE__*/external_react_.createElement(InputComponent, (0,esm_extends/* default */.Z)({
    ...
    className: external_clsx_default()(classes.input, inputPropsProp.className, fcs.disabled && classes.disabled, multiline && classes.inputMultiline, fcs.hiddenLabel && classes.inputHiddenLabel, startAdornment && classes.inputAdornedStart, endAdornment && classes.inputAdornedEnd, type === 'search' && classes.inputTypeSearch, fcs.margin === 'dense' && classes.inputMarginDense),
    onBlur: handleBlur,
    onChange: handleChange,
    onFocus: handleFocus
...
var Input = /*#__PURE__*/external_react_.forwardRef(function Input(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement(InputBase_InputBase, (0,esm_extends/* default */.Z)({
    classes: (0,esm_extends/* default */.Z)({}, classes, {
      root: external_clsx_default()(classes.root, !disableUnderline && classes.underline),
      underline: null
    }),
    fullWidth: fullWidth,
...
var FilledInput = /*#__PURE__*/external_react_.forwardRef(function FilledInput(props, ref) {
  var disableUnderline = props.disableUnderline,
      classes = props.classes,
      _props$fullWidth = props.fullWidth,
      fullWidth = _props$fullWidth === void 0 ? false : _props$fullWidth,
...
var NotchedOutline = /*#__PURE__*/external_react_.forwardRef(function NotchedOutline(props, ref) {
  var children = props.children,
      classes = props.classes,
      className = props.className,
      label = props.label,
  ...
  if (label !== undefined) {
    return /*#__PURE__*/external_react_.createElement("fieldset", (0,esm_extends/* default */.Z)({
      "aria-hidden": true,
      className: external_clsx_default()(classes.root, className),
      ref: ref,
      style: style
    }, other), /*#__PURE__*/external_react_.createElement("legend", {
      className: external_clsx_default()(classes.legendLabelled, notched && classes.legendNotched)
    }, label ? /*#__PURE__*/external_react_.createElement("span", null, label) : /*#__PURE__*/external_react_.createElement("span", {
...
var OutlinedInput = /*#__PURE__*/external_react_.forwardRef(function OutlinedInput(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement(InputBase_InputBase, (0,esm_extends/* default */.Z)({
    renderSuffix: function renderSuffix(state) {
      return /*#__PURE__*/external_react_.createElement(OutlinedInput_NotchedOutline, {
...
var FormLabel = /*#__PURE__*/external_react_.forwardRef(function FormLabel(props, ref) {
  var children = props.children,
      classes = props.classes,
      className = props.className,
      color = props.color,
  ...
  return /*#__PURE__*/external_react_.createElement(Component, (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, classes["color".concat((0,capitalize/* default */.Z)(fcs.color || 'primary'))], className, fcs.disabled && classes.disabled, fcs.error && classes.error, fcs.filled && classes.filled, fcs.focused && classes.focused, fcs.required && classes.required),
    ref: ref
  }, other), children, fcs.required && /*#__PURE__*/external_react_.createElement("span", {
    "aria-hidden": true,
    className: external_clsx_default()(classes.asterisk, fcs.error && classes.error)
  }, "\u2009", '*'));
});
 false ? 0 : void 0;
...
var InputLabel = /*#__PURE__*/external_react_.forwardRef(function InputLabel(props, ref) {
  var classes = props.classes,
      className = props.className,
  ...
  return /*#__PURE__*/external_react_.createElement(FormLabel_FormLabel, (0,esm_extends/* default */.Z)({
    "data-shrink": shrink,
    className: external_clsx_default()(classes.root, className, muiFormControl && classes.formControl, !disableAnimation && classes.animated, shrink && classes.shrink, fcs.margin === 'dense' && classes.marginDense, {
...
var FormControl = /*#__PURE__*/external_react_.forwardRef(function FormControl(props, ref) {
  var children = props.children,
      classes = props.classes,
      className = props.className,
  ...
  var _React$useState2 = external_react_.useState(function () {
    // We need to iterate through the children and find the Input in order
    // to fully support server-side rendering.
  ...
  var onFilled = external_react_.useCallback(function () {
    setFilled(true);
  }, []);
  var onEmpty = external_react_.useCallback(function () {
    setFilled(false);
  }, []);
  var childContext = {
  ...
  return /*#__PURE__*/external_react_.createElement(FormControl_FormControlContext.Provider, {
    value: childContext
  }, /*#__PURE__*/external_react_.createElement(Component, (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, className, margin !== 'none' && classes["margin".concat((0,capitalize/* default */.Z)(margin))], fullWidth && classes.fullWidth),
    ref: ref
  }, other), children));
});
 false ? 0 : void 0;
...
var FormHelperText = /*#__PURE__*/external_react_.forwardRef(function FormHelperText(props, ref) {
  var children = props.children,
      classes = props.classes,
      className = props.className,
      _props$component = props.component,
  ...
  return /*#__PURE__*/external_react_.createElement(Component, (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, (fcs.variant === 'filled' || fcs.variant === 'outlined') && classes.contained, className, fcs.disabled && classes.disabled, fcs.error && classes.error, fcs.filled && classes.filled, fcs.focused && classes.focused, fcs.required && classes.required, fcs.margin === 'dense' && classes.marginDense),
    ref: ref
  }, other), children === ' ' ?
  /*#__PURE__*/
...
var ListContext = external_react_.createContext({});
...
var List = /*#__PURE__*/external_react_.forwardRef(function List(props, ref) {
  var children = props.children,
      classes = props.classes,
      className = props.className,
      _props$component = props.component,
  ...
  return /*#__PURE__*/external_react_.createElement(List_ListContext.Provider, {
    value: context
  }, /*#__PURE__*/external_react_.createElement(Component, (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, className, dense && classes.dense, !disablePadding && classes.padding, subheader && classes.subheader),
    ref: ref
...
var MenuList_useEnhancedEffect = typeof window === 'undefined' ? external_react_.useEffect : external_react_.useLayoutEffect;
/**
...
var MenuList = /*#__PURE__*/external_react_.forwardRef(function MenuList(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement(List_List, (0,esm_extends/* default */.Z)({
    role: "menu",
    ref: handleRef,
    className: className,
    onKeyDown: handleKeyDown,
...
var SelectInput = /*#__PURE__*/external_react_.forwardRef(function SelectInput(props, ref) {
  ...
  var _React$useRef = external_react_.useRef(openProp != null),
  ...
  external_react_.useImperativeHandle(handleRef, function () {
    return {
  ...
  var childrenArray = external_react_.Children.toArray(children); // Support autofill.
  ...
  var items = childrenArray.map(function (child) {
    ...
    if (multiple) {
      if (!Array.isArray(value)) {
        throw new Error( false ? 0 : (0,utils_.formatMuiErrorMessage)(2));
      }
  ...
  external_react_.createElement("span", {
  ...
  }) : display), /*#__PURE__*/external_react_.createElement("input", (0,esm_extends/* default */.Z)({
    ...
    autoFocus: autoFocus
  }, other)), /*#__PURE__*/external_react_.createElement(IconComponent, {
    className: external_clsx_default()(classes.icon, classes["icon".concat((0,capitalize/* default */.Z)(variant))], open && classes.iconOpen, disabled && classes.disabled)
  }), /*#__PURE__*/external_react_.createElement(Menu_Menu, (0,esm_extends/* default */.Z)({
    id: "menu-".concat(name || ''),
...
var NativeSelectInput = /*#__PURE__*/external_react_.forwardRef(function NativeSelectInput(props, ref) {
  var classes = props.classes,
      className = props.className,
      disabled = props.disabled,
      IconComponent = props.IconComponent,
  ...
  return /*#__PURE__*/external_react_.createElement(external_react_.Fragment, null, /*#__PURE__*/external_react_.createElement("select", (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, // TODO v5: merge root and select
    classes.select, classes[variant], className, disabled && classes.disabled),
    disabled: disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : /*#__PURE__*/external_react_.createElement(IconComponent, {
    className: external_clsx_default()(classes.icon, classes["icon".concat((0,capitalize/* default */.Z)(variant))], disabled && classes.disabled)
  }));
});
 false ? 0 : void 0;
...
var defaultInput = /*#__PURE__*/external_react_.createElement(Input_Input, null);
/**
 * An alternative to `<Select native />` with a much smaller bundle size footprint.
 */

var NativeSelect = /*#__PURE__*/external_react_.forwardRef(function NativeSelect(props, ref) {
  var children = props.children,
      classes = props.classes,
  ...
  return /*#__PURE__*/external_react_.cloneElement(input, (0,esm_extends/* default */.Z)({
...
var _ref = /*#__PURE__*/external_react_.createElement(Input_Input, null);

var _ref2 = /*#__PURE__*/external_react_.createElement(FilledInput_FilledInput, null);

var Select = /*#__PURE__*/external_react_.forwardRef(function Select(props, ref) {
  ...
  var InputComponent = input || {
    standard: _ref,
    outlined: /*#__PURE__*/external_react_.createElement(OutlinedInput_OutlinedInput, {
      label: label,
      labelWidth: labelWidth
    }),
    filled: _ref2
  }[variant];
  return /*#__PURE__*/external_react_.cloneElement(InputComponent, (0,esm_extends/* default */.Z)({
    ...
    inputProps: (0,esm_extends/* default */.Z)({
      ...
      classes: inputProps ? (0,styles_.mergeClasses)({
        baseClasses: classes,
...
var TextField = /*#__PURE__*/external_react_.forwardRef(function TextField(props, ref) {
  ...
  if (variant === 'outlined') {
    ...
    if (label) {
      ...
      InputMore.label = /*#__PURE__*/external_react_.createElement(external_react_.Fragment, null, label, displayRequired && "\xA0*");
    }
  }
  ...
  var InputElement = /*#__PURE__*/external_react_.createElement(InputComponent, (0,esm_extends/* default */.Z)({
  ...
  return /*#__PURE__*/external_react_.createElement(FormControl_FormControl, (0,esm_extends/* default */.Z)({
    className: external_clsx_default()(classes.root, className),
    disabled: disabled,
    error: error,
    fullWidth: fullWidth,
    ...
    color: color,
    variant: variant
  }, other), label && /*#__PURE__*/external_react_.createElement(InputLabel_InputLabel, (0,esm_extends/* default */.Z)({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? /*#__PURE__*/external_react_.createElement(Select_Select, (0,esm_extends/* default */.Z)({
    "aria-describedby": helperTextId,
    id: id,
    labelId: inputLabelId,
    value: value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && /*#__PURE__*/external_react_.createElement(FormHelperText_FormHelperText, (0,esm_extends/* default */.Z)({
    id: helperTextId
